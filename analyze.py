...
def freq_events_team_repo(index, doc_type, event_type, repo):
	params = {}
	params["event_type"] = event_type
	params["repo"] = repo
	average = get_frequency(index, doc_type, params)
...
# print(get_frequency("static", "events"))
print(freq_events_team_repo("static", "events", "B", "proj1"))
...
# frequency of event types captured per team = # avg time between any captured events per team [=== DONE ===]
...
# To Do:
	...
	# 1. Change mapping to not analyze fields like team and repo and turn them into keywords [=== DONE ===]
	...
	# 4. Write Elastic Search queries for each metric [=== DONE ===]
